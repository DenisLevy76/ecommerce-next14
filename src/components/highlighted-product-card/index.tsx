...
export const HighlightedProductCard: React.FC<HighlightedProductCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        title={title}
        className="flex gap-4 text-sm md:text-base md:gap-8 items-center absolute max-w-[65%] bottom-9 left-1/2 md:left-9 -translate-x-1/2 md:translate-x-0 bg-background/50 px-2 py-1 rounded-md"
      >
